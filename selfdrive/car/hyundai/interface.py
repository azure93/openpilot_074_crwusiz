...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):
    ...
    if candidate == CAR.GENESIS:
    ...
    elif candidate in [CAR.GENESIS_G80, CAR.GENESIS_G90]:
      ...
      ret.lateralTuning.pid.kiBP, ret.lateralTuning.pid.kpBP = [[0.], [0.]]
      ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.25], [0.05]]
    elif candidate in [CAR.SONATA20, CAR.SONATA20_HEV]:
      ret.lateralTuning.pid.kf = 0.00005
    ...
    # get actual value, for now starting with reasonable value for
    # civic and scaling by mass and wheelbase
    ret.rotationalInertia = scale_rot_inertia(ret.mass, ret.wheelbase)

    # start from empirically derived lateral slip stiffness for the civic and scale by
 ...
 #  if self.CP.carFingerprint in [CAR.K5, CAR.K5_HEV]:
