...
ALERTS = [
  ...
  Alert(
      ...
      "항상 핸들을 잡고 전방주시 하세요",
      AlertStatus.normal, AlertSize.mid,
      Priority.LOWER, VisualAlert.none, AudibleAlert.chimeWarning1, .4, 0., 5.),
  ...
  Alert(
      ...
      "기어를 [D]로 변경하세요",
      AlertStatus.normal, AlertSize.mid,
      Priority.LOW, VisualAlert.none, AudibleAlert.chimeGeard, 2.1, 2., 3.),
  ...
  Alert(
      ...
      "캘리브레이션 진행중입니다",
      AlertStatus.normal, AlertSize.mid,
      Priority.LOW, VisualAlert.none, AudibleAlert.chimeCalibration2, 1.8, 2., 3.),
  ...
  Alert(
      ...
      "차선인식상태가 좋지않으니 주의운전하세요",
      AlertStatus.normal, AlertSize.mid,
      Priority.LOW, VisualAlert.none, AudibleAlert.chimeVision, 4., 2., 3.),
